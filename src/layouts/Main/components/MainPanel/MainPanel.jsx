    ...
    <div className="main_container">
      ...
      <div className="panel_content">
        ...
        <section className="content_btn_schools">
          <SchoolButton text="Ciencias Creativas Arte, Diseño e Ingenierías" icon={<FcIdea />}schoolText="Escuela de:" />
          <SchoolButton text="Ciencias Administrativas, sociales y Humanas" icon= {<FcLibrary />
        ...
        <section className="about">
          ...
          <div className="about_image">
            <img src="src\resources\images\logoAplication\tutoriaIUSH.png" alt="Estudiantes en tutoría" />
          </div>
        </section>

        <section className="expert_path">
          <h2 className="expert_title">Vuélvete un Experto</h2>
          <div className="expert_options">
            <ExpertCard title="Tutorías" subtitle="Recibe orientación de expertos que te ayudarán a resolver dudas y reforzar conocimientos." icon= {<FcReadingEbook />}/> 
            <ExpertCard title="Talleres" subtitle="Aprende haciendo con sesiones interactivas diseñadas para aplicar la teoría en escenarios reales." icon={<FcFinePrint />}/>
            <ExpertCard title="Rutas de Aprendizaje" subtitle="Sigue un plan estructurado que te guiará paso a paso hacia el dominio de nuevas habilidades." icon={<FcMindMap />}/>
          </div>
        </section>
      </div>
